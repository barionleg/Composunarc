...
Dropdown.prototype={constructor:Dropdown,toggle:function(e){var $this=$(this),$parent,isActive,isHover
if($this.is('.disabled, :disabled'))return
$parent=getParent($this)
isActive=$parent.hasClass('open')
isHover=$parent.parent().hasClass('nav-hover')
clearMenus()
if((!isActive&&e.type=='click')||(isHover&&e.type=='mouseover')){$parent.parent().toggleClass('nav-hover')
...
$('body').on('click.dropdown','.dropdown',function(e){e.stopPropagation()}).on('click.dropdown.data-api',toggle,Dropdown.prototype.toggle).on('keydown.dropdown.data-api',toggle+', [role=menu]',Dropdown.prototype.keydown).on('mouseover.dropdown.data-api',toggle,Dropdown.prototype.toggle)})}(window.jQuery);!function($){"use strict";var Modal=function(element,options){this.options=options
